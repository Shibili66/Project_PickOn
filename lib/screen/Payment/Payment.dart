...
import '../Slider_Menu/Myprofile.dart';
             ...
             title: InkWell(
                 onTap: () {
                   showDialog(context: context,
                       builder: (context){
                         return AlertDialog(
                           title: Text("Enter Your Wallet linked No."),
                           content: TextFormField(
                           ...
                           content: ListView(
                             ...
                             onChanged: (value) => setState(() => selectedValue = 0,
                               ...
                               RadioListTile<int>(
                                 value: 4,
                                 groupValue: selectedValue,
                                 title: Text("Kotak Mahindra Bank"),
                                 onChanged: (value) => setState(() => selectedValue = 0,
                                 ),),
                               RadioListTile<int>(
                                 value: 5,
                               ...
                               child: Column(
                                 children: [
                                   Padding(
                                     ...
                                     child: Text("Card No.",style: TextStyle(color: Colors.black54,fontSize:15),),
                                   ),
                                   Padding(
                                   ...
                                   Padding(
                                     ...
                                     child: Text("Valid thru.",style: TextStyle(color: Colors.black54,fontSize:15),),
                                   ),
                                   Padding(
                                   ...
                                   Padding(
                                     padding: const EdgeInsets.only(right:120,top: 18),
                                     child: SizedBox(
                                       width: 90,
                                       child: TextFormField(
                                         keyboardType: TextInputType.number,
